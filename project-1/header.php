        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="form_nilai_get.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form Nilai Get</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="form_nilai_post.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form Nilai Post</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pr-3.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pr-4.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Form Nilai</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pr-5.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ATM</p>
                </a>
              </li>
